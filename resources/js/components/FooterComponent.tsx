...
const FooterComponent = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-white to-gray-50 dark:from-black dark:to-stone-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-600 via-gray-700 to-gray-600">
                Copper Artistry
              </h3>
              <p className="mt-4 text-stone-600 dark:text-gray-100/80 text-sm leading-relaxed">
            ...
            <div className="flex space-x-4">
              {[
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700/30 dark:to-gray-600/30 flex items-center justify-center group transition-colors duration-300"
                >
                  <svg 
                    className="w-5 h-5 text-gray-700 dark:text-gray-500 group-hover:text-gray-800 dark:group-hover:text-gray-400 transition-colors duration-300" 
                    fill="currentColor" 
                    viewBox="0 0 24 24"
                  >
                    <path d={social.icon} />
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  <svg className="w-6 h-6 text-gray-600 dark:text-gray-500 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <span className="text-stone-600 dark:text-gray-100/80">
                    123 Rue du Cuivre<br />
                    75001 Paris, France
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg className="w-6 h-6 text-gray-600 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-200/20 dark:border-gray-700/30 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <motion.p 
              ...
              className="text-stone-600 dark:text-gray-100/80 text-sm"
            >
            ...
            >
              {['Mentions Légales', 'Politique de Confidentialité', 'CGV'].map((item, index) => (
                <a
                  key={index}
                  href="#"
                  className="text-sm text-stone-600 dark:text-gray-100/80 hover:text-gray-700 dark:hover:text-gray-400 transition-colors duration-300"
                >
                  {item}
                </a>
              ))}
