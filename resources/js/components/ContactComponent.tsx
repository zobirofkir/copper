    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 relative" ref={ref}>
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="mt-8 text-lg text-stone-700 dark:text-amber-100/90 max-w-2xl mx-auto"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          >
            ...
            <p className="text-stone-700 dark:text-amber-100/90 text-center leading-relaxed mb-6">
            ...
            <div className="flex justify-center">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-amber-600 text-amber-50 rounded-lg shadow-lg shadow-amber-900/30 transition-all duration-300 transform hover:shadow-xl flex items-center justify-center"
              >
        ...
        >
          <motion.h3 
            variants={itemVariants}
            className="text-3xl md:text-4xl font-bold mb-10 text-amber-700 dark:text-amber-500 text-center"
          >
            Nous Trouver
          </motion.h3>
          ...
          <motion.div 
            variants={itemVariants}
            className="rounded-xl overflow-hidden shadow-2xl border-4 border-amber-100 dark:border-amber-800/50"
          >
            <iframe 
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div variants={itemVariants}>
                <label htmlFor="name" className="block text-sm font-medium text-stone-700 dark:text-amber-100 mb-2">Nom</label>
                <input 
                  type="text" 
                  id="name" 
                  className="w-full px-4 py-3 rounded-lg bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700/50 focus:outline-none focus:ring-2 focus:ring-amber-500 text-stone-800 dark:text-amber-100"
                  placeholder="Votre nom"
                />
              </motion.div>
              
              <motion.div variants={itemVariants}>
                <label htmlFor="email" className="block text-sm font-medium text-stone-700 dark:text-amber-100 mb-2">Email</label>
                <input 
                  type="email" 
                  id="email" 
                  className="w-full px-4 py-3 rounded-lg bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700/50 focus:outline-none focus:ring-2 focus:ring-amber-500 text-stone-800 dark:text-amber-100"
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="subject" className="block text-sm font-medium text-stone-700 dark:text-amber-100 mb-2">Sujet</label>
              <input 
                type="text" 
                id="subject" 
                className="w-full px-4 py-3 rounded-lg bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700/50 focus:outline-none focus:ring-2 focus:ring-amber-500 text-stone-800 dark:text-amber-100"
            ...
            <motion.div variants={itemVariants}>
              <label htmlFor="message" className="block text-sm font-medium text-stone-700 dark:text-amber-100 mb-2">Message</label>
              <textarea 
                id="message" 
                rows={6} 
                className="w-full px-4 py-3 rounded-lg bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700/50 focus:outline-none focus:ring-2 focus:ring-amber-500 text-stone-800 dark:text-amber-100"
