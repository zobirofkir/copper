            ...
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 md:p-12 lg:p-16 max-w-7xl mx-auto text-center">
                <motion.div
                  ...
                  className="h-0.5 bg-gradient-to-r from-transparent via-black to-transparent dark:bg-white mb-8 overflow-hidden"
                />
                ...
                <motion.div
                  ...
                  className="h-0.5 bg-gradient-to-r from-transparent via-black to-transparent dark:dark:bg-white mt-8 overflow-hidden"
                />
              </div>
            </div>
          </div>
